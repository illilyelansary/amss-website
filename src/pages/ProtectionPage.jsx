...
const hasProtectionDomain = (domainStr) => {
  const parts = splitDomains(domainStr)
  // jeux de valeurs possibles après normalisation
  return parts.includes('Protection & VBG') || parts.some(d => /protection/i.test(d))
}
