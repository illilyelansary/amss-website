...
const ZonesSection = () => {
  const zones = [
    ...
    {
      name: "Ménaka",
      description: "Focus sur la protection des populations déplacées et la sécurité alimentaire",
      projects: 12,
    ...
    {
      name: "Mopti",
      description: "Programmes de gouvernance, éducation et lutte contre l'extrémisme violent",
      projects: 15,
    ...
    {
      name: "Bamako",
      description: "Bureau de coordination et projets de lutte contre l'extrémisme violent",
      projects: 5,
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          {zones.map((zone, index) => (
            <div
              key={index}
              className="bg-white rounded-xl p-6 shadow-sm border border-border hover:shadow-lg transition-all duration-300 hover:-translate-y-1"
            >
              {/* Zone header */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-muted-foreground mb-6 leading-relaxed">
                Depuis sa création en 1991, l'AMSS a progressivement étendu sa zone d'intervention 
                du cercle de Goundam à l'ensemble du territoire malien. Cette expansion géographique 
                nous permet de répondre aux besoins diversifiés des populations vulnérables dans 
                différents contextes socio-économiques et sécuritaires.
              </p>
